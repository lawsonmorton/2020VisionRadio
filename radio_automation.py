...
# --- 2. FETCH FACEBOOK & YOUTUBE RSS FEEDS ---
media_context_items = []
rss_sources = [
...
for source_name, rss_url in rss_sources:
  if rss_url:
    try:
      ...
      for entry in feed.entries[:5]:  # Fetch 5 latest items
      ...
      print(f"Notice: Could not parse {source_name} RSS feed ({rss_url}): {rss_err}")

fb_context_str = ""
if media_context_items:
  fb_context_str = (
      "\nLATEST OFFICIAL SOCIAL MEDIA, POLICE BULLETINS & YOUTUBE NEWS FEEDS:\n"
...
system_prompt = (
    ...
    " Nevis. Provide an in-depth breakdown including synoptic analysis,"
    " island-by-island breakdown (Basseterre, Sandy Point, Nevis Peak,"
    " Charlestown), marine swell advisory, tide schedules, and 5-day outlook.\n "
    "  * SPECIAL WEATHER RULE: Right after the Friday weather forecast section,"
    " you MUST create a dedicated section titled 'Weekend Outlook' that gives a"
    " detailed forecast specifically for Saturday and Sunday.\n3. SPORTS"
    ...
    " RULES:\n- DO NOT mention segment durations, lengths, or word counts"
    " inside the generated script text (e.g. do not write '30 Minutes' or '4000"
    " words').\n- DO NOT invent fictional persons or names (e.g., do NOT use"
    " fictional names like 'Marcus St. Clair'). Report ONLY real, verifiable"
    ...
    " brackets next to each story (e.g., [Source: https://...]).\n- MEDIA LINKS"
    " REQUIREMENT: If an item includes associated audio or video, include"
