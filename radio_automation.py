...
system_prompt = (
    ...
    " SCRIPT REQUIREMENTS:\n1. NEWS SEGMENT: Provide comprehensive,"
    " multi-paragraph reporting for St. Kitts & Nevis, Antigua & Barbuda,"
    " Anguilla, Sint Maarten, Statia, Saba, Montserrat, and Wider Caribbean."
    " Include historical context, official statements, and station break"
    " placeholders.\n2. WEATHER SEGMENT: Focus EXCLUSIVELY on St. Kitts and"
    " Nevis.\n   * DAILY WEATHER RULE: Provide the forecast strictly for"
    f" tomorrow's date ({date_str}) ONLY. Do NOT include a 5-day forecast or"
    " general multi-day outlook.\n   * THURSDAY SPECIAL RULE: If tomorrow's"
    " date is Friday (script generated on Thursday), you MUST create a"
    " dedicated section immediately after Friday's forecast titled 'Weekend"
    " Outlook', providing a detailed weather forecast specifically for Saturday"
    " and Sunday.\n   * Forecast details must include synoptic analysis,"
    " island-by-island breakdown (Basseterre, Sandy Point, Nevis Peak,"
    " Charlestown), marine swell advisories, and tide schedules.\n3. SPORTS"
    " SEGMENT: Lead with St. Kitts & Nevis local athletics and community"
    " cricket/football leagues, followed by Leeward Islands Cricket, CWI,"
    " CONCACAF, and regional sports updates.\n\nACCURACY & FORMATTING"
    " RULES:\n- DO NOT mention segment durations, timing lengths, or word counts"
    " inside the generated script text (e.g. do NOT write '30 Minutes', '7"
    " Minutes', or '4000 words').\n- DO NOT invent fictional persons or names"
    " (e.g., do NOT use hallucinated names like 'Marcus St. Clair'). Report ONLY"
    " real, verifiable public officials and real citizens.\n- Write in clear,"
    " spoken radio-presenter English for 2020 Vision Radio 102.1 FM.\n- Include"
    " stage cues in brackets like [pause], [station intro sting], [transition"
    " sting], and commercial break placeholders.\n- MUST include direct source"
    " URLs in brackets next to each story (e.g., [Source: https://...]).\n- MEDIA"
    " LINKS REQUIREMENT: If an item includes associated audio or video, include"
    " direct access links inside the source brackets (e.g. [Source:"
    " https://... | Audio: https://... | Video:"
...
msg["Subject"] = (
    f"2020 Vision Radio 102.1 FM Script - For {tomorrow.strftime('%A, %b %d')}"
)

body = (
    f"Hello Team,\n\nAttached is tomorrow's automated news, weather, and sports"
    f" script for 2020 Vision Radio 102.1 FM ({date_str}).\n\nScheduled"
