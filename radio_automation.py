...
if os.path.exists(HISTORY_FILE):
  try:
    with open(HISTORY_FILE, "r") as f:
      ...
      # Keep track of story topics from the past 5 days
...
try:
  ...
  # Models to attempt in order if rate limits occur
  candidate_models = [
      "gemini-2.0-flash",
      ...
      for part in parts[1:]:
        if "]" in part:
          ...
          if cue_text.startswith("Source:"):
            ...
            r_cue.font.color.rgb = RGBColor(0x55, 0x55, 0x55)  # Grey for URLs
          else:
